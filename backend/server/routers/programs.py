...
from data.processors.models import (CourseContainer, Program, ProgramContainer,
                                    Specialisation)
...
from server.routers.model import (CourseCodes, Courses, CoursesPathDict, Graph,
                                  Programs, Structure, StructureContainer,
                                  StructureDict)

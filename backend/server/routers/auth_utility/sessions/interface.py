...
from .storage import RefreshToken, SessionID, SessionOIDCInfo, SessionToken, SessionTokenInfo, destroy_session, get_refresh_token_info, get_session_info, get_session_token_info, insert_new_refresh_info, insert_new_session_token_info, setup_new_session, update_session
...
def get_oidc_info(refresh_token: RefreshToken) -> Tuple[SessionID, SessionOIDCInfo]:
    ...
    return (sid, session_info.oidc_info)
...
def new_login_session(uid: str, oidc_info: SessionOIDCInfo) -> Tuple[SessionToken, int, RefreshToken]:
    ...
    refresh_token = insert_new_refresh_info(sid, REFRESH_TOKEN_LIFETIME)
...
def new_token_pair(sid: SessionID, new_oidc_info: SessionOIDCInfo) -> Tuple[SessionToken, int, RefreshToken]:

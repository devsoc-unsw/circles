...
CODE_MAPPING = dataHelpers.read_data("utility/programCodeMappings.json")["title_to_code"]

def customise_spn_data():

    data = dataHelpers.read_data("scrapers/specialisationsFormattedRaw.json")
    ...
    dataHelpers.write_data(customised_data, "finalData/specialisationsProcessed.json")

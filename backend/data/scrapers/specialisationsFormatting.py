...
def format_spn_data():
    ...
    raw_content = dataHelpers.read_data("scrapers/specialisationsPureRaw.json")
    specialisations = {}
    ...
    dataHelpers.write_data(specialisations, 'scrapers/specialisationsFormattedRaw.json')    
